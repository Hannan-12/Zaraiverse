...
export default function FarmerStack() {
  return (
    ...
    >
      ...
      <Stack.Screen name="WeatherDetail" component={WeatherDetailScreen} options={{ title: 'Hourly Details', headerStyle: { backgroundColor: '#4FC3F7' }, headerTransparent: true, headerTitle: '' }} />
      ...
      <Stack.Screen name="Analytics" component={AnalyticsScreen} options={{ title: 'Prescriptive Analytics' }} />
      ...
      <Stack.Screen name="AddField" component={AddFieldScreen} options={{ title: 'Add/Edit Field' }} />
