...
export default function TaskRemindersScreen() {
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.textContainer}>
            ...
            <View style={styles.dateRow}>
              ...
              <Text style={styles.taskDate}>{format(item.taskTime, 'MMM d, h:mm a')}</Text>
            </View>
          </View>
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <TouchableOpacity style={styles.fabContainer} onPress={() => handleOpenModal()} activeOpacity={0.8}>
        <LinearGradient colors={['#2E8B57', '#1B5E20']} style={styles.fab}>
...
const styles = StyleSheet.create({
  ...
  headerGradient: { paddingTop: 60, paddingBottom: 25, paddingHorizontal: 20, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, elevation: 8 },
  headerTitle: { fontSize: 28, fontWeight: '800', color: '#fff' },
  headerSubtitle: { fontSize: 14, color: '#E8F5E9', marginTop: 4, opacity: 0.9 },
  listContent: { padding: 20, paddingBottom: 100 },
  card: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 16, marginBottom: 16, overflow: 'hidden', elevation: 4 },
  cardCompleted: { opacity: 0.7 },
  cardStrip: { width: 6, height: '100%' },
  cardContent: { flex: 1, flexDirection: 'row', alignItems: 'center', padding: 15 },
  checkboxBase: { width: 24, height: 24, borderRadius: 12, borderWidth: 2, borderColor: '#CFD8DC', justifyContent: 'center', alignItems: 'center', marginRight: 15 },
  checkboxChecked: { backgroundColor: '#2E8B57', borderColor: '#2E8B57' },
  ...
  actionBtn: { padding: 8 },
  fabContainer: { position: 'absolute', right: 20, bottom: 20, elevation: 8 },
  fab: { width: 60, height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center' },
  emptyState: { alignItems: 'center', marginTop: 60 },
  emptyIconCircle: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#E8F5E9', justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  emptyTitle: { fontSize: 20, fontWeight: 'bold', color: '#333' },
  emptySubtitle: { fontSize: 14, color: '#777', marginTop: 5 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  modalCard: { width: '85%', backgroundColor: '#fff', borderRadius: 20, padding: 25, elevation: 10 },
  ...
  input: { backgroundColor: '#F5F7FA', borderRadius: 12, padding: 14, fontSize: 16, borderWidth: 1, borderColor: '#E0E0E0', marginBottom: 20 },
  dateButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F5F7FA', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#E0E0E0', marginBottom: 25 },
  dateButtonText: { marginLeft: 10, fontSize: 16, color: '#333' },
  modalButtons: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
  cancelBtn: { flex: 1, backgroundColor: '#ECEFF1', padding: 14, borderRadius: 12, marginRight: 10, alignItems: 'center' },
  cancelBtnText: { color: '#546E7A', fontWeight: 'bold', fontSize: 16 },
  saveBtn: { flex: 1, paddingHorizontal: 30, paddingVertical: 14, borderRadius: 12, alignItems: 'center' },
